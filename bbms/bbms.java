...
class patient extends blood_stock
{
	//Declaring variables.
	...
	void new_patient()
	{
		...
		rbg4 = input.next();
		if(!(rbg4.equals("A+")||rbg4.equals("B+")||rbg4.equals("AB+")||rbg4.equals("O+")||rbg4.equals("A-")||rbg4.equals("B-")||rbg4.equals("AB-")||rbg4.equals("O-")||rbg4.equals("a+")||rbg4.equals("b+")||rbg4.equals("ab+")||rbg4.equals("o+")||rbg4.equals("a-")||rbg4.equals("b-")||rbg4.equals("ab-")||rbg4.equals("o-")))
		{
			System.out.println("Input you entered is not a blood group. Please try again");
		}
		else
		{
			...
			quan = input.nextInt();
			if(rbg4.equals("A+") || rbg4.equals("a+"))
			{
				if(quan>qua1)
				{
			...
			else if(rbg4.equals("A-") || rbg4.equals("a-"))
			{
				if(quan>qua2)
				{
					System.out.println("Sorry the quantity exceeds the stock.");
			...
			else if(rbg4.equals("B+") || rbg4.equals("b+"))
			{
				if(quan>qua3)
				{
					System.out.println("Sorry the quantity exceeds the stock.");
			...
			else if(rbg4.equals("O+") || rbg4.equals("o+"))
			{
				if(quan>qua5)
				{
					System.out.println("Sorry the quantity exceeds the stock.");
			...
			else if(rbg4.equals("AB+") || rbg4.equals("ab+"))
			{
				if(quan>qua7)
				{
					System.out.println("Sorry the quantity exceeds the stock.");
...
class blood_cell
{
	//Method to show blood cell details
				...
				case 3:
				{
					...
					while(s1==1)
					{
						...
						else if(c1==2)
						{
							for(j=0;j<count1;j++)
							{
								System.out.print("the patient details:-");
								//p[j]= new patient();
								p[j].patient_info();
							}
							//break;
